...
void DispTime() 
{
  int hourdigit1 =(data_now.hour())/10;
  int hourdigit2 =(data_now.hour())%10;
  int mindigit1 =(data_now.minute())/10;
  int mindigit2 =(data_now.minute())%10;
  int secdigit1 =(data_now.second())/10;
  int secdigit2 =(data_now.second())%10;
